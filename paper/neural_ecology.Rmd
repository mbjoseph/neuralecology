...
Species distribution models are increasingly scalable due to advances in approximate Gaussian process models [@tikhonov2019computationally], but multispecies dynamic occupancy models have not previously been reported at this scale.
...
<!-- TODO: Ensure vector notation is consistent in supplements -->
...
The convolutional movmement model was implemented with PyTorch [@paszke2017automatic]. 
