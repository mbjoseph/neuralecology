...
\huge Ecological models $\rightleftharpoons$ neural networks
...
- Optimal labeling\footnote[frame]{Stratton, Christian, et al. "Coupling validation effort with in situ bioacoustic data improves estimating relative activity and occupancy for multiple species with cross‐species misclassifications." Methods in Ecology and Evolution (2022).}
...
\small
**Get in touch:** max.joseph@ncx.com, @maxj@ecoevo.social
...
Andy Royle, Angela Fuller, Kathi Irvine, Ben Augustine, Toryn Schafer, Richard Chandler
